    ...
    if (!ytConnected) {
      ...
      try {
        const res = await fetch(
          `${import.meta.env.VITE_API_BASE_URL}/api/auth/disconnect-youtube`,
          {
            method: "POST",
            credentials: "include",
          }
  ...
  const handlePost = async (video: Video) => {
    ...
    try {
      ...
      if (ytSuccess) {
        if (igSuccess) {
          toast.success(
            "Congratulations, your video was published to YouTube and Instagram!"
          );
        } else {
          toast.success(
            "Congratulations, your video was published to YouTube!"
          );
        }
        setPlatformSelections((prev) => ({
          ...prev,
        ...
        <div className="p-6 md:p-8 max-w-7xl mx-auto">
          <div className="mb-10 text-left">
            ...
            <p className="text-slate-300 text-base max-w-2xl text-left leading-relaxed">
              Connect your social accounts, customize your content, and publish
              to multiple platforms with ease
            </p>
          </div>
          ...
          <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm border border-slate-700/50 rounded-3xl p-8 mb-12 shadow-2xl">
            ...
            <p className="text-slate-400 text-base mb-8 leading-relaxed">
              Connect your social media accounts to start publishing your
                      ...
                      <div className="flex items-center gap-2">
                        <div
                          className={`w-2 h-2 rounded-full ${
                            ytConnected ? "bg-green-400" : "bg-slate-500"
                          } animate-pulse`}
                        />
                        <p
                          className={`text-sm font-medium ${
                            ytConnected ? "text-green-400" : "text-white/80"
                          }`}
                        >
                    ...
                    <div className="space-y-4">
                      <div className="bg-green-500/10 border border-green-500/20 rounded-xl p-4">
                        ...
                        <p className="text-green-300/80 text-sm">
                          Your YouTube account is ready for publishing
                        </p>
                      </div>
                      <Button
                ...
                <div className="relative">
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2">
                        <div
                          className={`w-2 h-2 rounded-full ${
                            igConnected ? "bg-green-400" : "bg-slate-500"
                          } animate-pulse`}
                        />
                        <p
                          className={`text-sm font-medium ${
                            igConnected ? "text-green-400" : "text-white/80"
                          }`}
                        >
                  ...
                  {igConnected ? (
                    <div className="bg-green-500/10 border border-green-500/20 rounded-xl p-4">
                      ...
                      <p className="text-green-300/80 text-sm">
                        Your Instagram account is ready for publishing
                      </p>
                    </div>
                  ) : (
                    <Button
          ...
          {/* Tabs for Scheduled and Past Publications */}
          <Tabs defaultValue="scheduled" className="w-full">
            <TabsList className="grid w-full grid-cols-2 max-w-md">
              <TabsTrigger value="scheduled">Scheduled</TabsTrigger>
              <TabsTrigger value="past">Past Publications</TabsTrigger>
            </TabsList>
                    ...
                    <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm border border-slate-700/50 rounded-3xl p-8 shadow-2xl">
                      <div className="flex items-center justify-between mb-8">
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            ...
                            <p className="text-slate-400 text-base mt-1">
                              Generated images ready to share on Instagram
                            </p>
                          </div>
                        </div>
                        <div className="hidden sm:flex items-center gap-2 px-4 py-2 bg-slate-800/50 rounded-xl border border-slate-600/50">
                      ...
                      {imagesLoading ? (
                        ...
                        <div className="flex flex-col items-center justify-center text-center py-20 border-2 border-dashed border-slate-600/50 rounded-2xl bg-slate-800/20">
                          ...
                          <p className="text-slate-400 mb-6 max-w-md mx-auto">
                            Generate your first image to start sharing on
                            Instagram
                          </p>
                          <Button
                            className="bg-storiq-purple hover:bg-storiq-purple/80 text-white font-medium px-8 py-3 shadow-lg hover:shadow-xl transition-all duration-300"
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
                          {images.map((img, idx) => (
                            <ImagePublishCard
                              key={
                                img.id || img.s3Key || img.url || `image-${idx}`
                              }
                              image={img}
                              igConnected={igConnected}
                              handlePost={handlePost}
              ...
              <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm border border-slate-700/50 rounded-3xl p-8 shadow-2xl">
                <div className="flex flex-col items-center justify-center text-center py-20">
                  ...
                  <p className="text-slate-400 max-w-md mx-auto">
                    Your published content history will appear here. This
        ...
        <div className="flex items-center gap-2 mb-4 p-3 bg-slate-800/50 rounded-xl">
          ...
          <div className="flex-1">
            ...
            <p className="text-slate-400 text-xs">
              {igConnected ? "Ready to post" : "Connect to post"}
            </p>
          </div>
          <div
            className={`w-2 h-2 rounded-full ${
