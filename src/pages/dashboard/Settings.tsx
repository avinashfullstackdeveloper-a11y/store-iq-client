...
const EyeIcon = ({ open }: { open: boolean }) => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    {open ? (
      <>
        <path d="M3 12C5.5 7 9.5 4 12 4C14.5 4 18.5 7 21 12C18.5 17 14.5 20 12 20C9.5 20 5.5 17 3 12Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
...
const PasswordIcon = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M7 10V6C7 3.79086 8.79086 2 11 2H13C15.2091 2 17 3.79086 17 6V10" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
    ...
    <DashboardLayout>
      <div className="p-8 bg-[#111111] min-h-screen">
        <div className="mb-8">
          ...
          <p className="text-white/60 text-lg">Manage your account preferences and security</p>
        </div>

        <div className="flex gap-8 items-stretch h-full">
          {/* Enhanced Left Sidebar */}
          <aside className="w-80 flex-shrink-0 h-full flex flex-col">
          ...
          <main className="flex-1 flex flex-col h-full">
            ...
            {activeTab === "Your Timezone" && (
              <div className="bg-gradient-to-br from-[#1E1E1E] to-[#2A2A2A] border border-[#3A3A3A] rounded-2xl p-8 shadow-2xl">
                  ...
                  <div className="bg-[#2A2A2A] border border-[#3A3A3A] rounded-xl p-6">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        <span className="text-[#6E42E1] font-semibold text-lg">{timezone}</span>
            ...
            {activeTab === "Integrations" && (
              <div className="bg-gradient-to-br from-[#1E1E1E] to-[#2A2A2A] border border-[#3A3A3A] rounded-2xl p-8 shadow-2xl flex flex-col h-full">
                <div className="flex-1 flex flex-col">
                  ...
                  <p className="text-white/60 mb-6">
                    Connect your social media accounts to schedule content seamlessly
                  </p>
                  
                  <div className="bg-[#2A2A2A] border border-[#3A3A3A] rounded-xl p-6 mb-6">
                    <div className="flex items-center justify-between mb-4">
                      <span className="text-white font-medium">Current Connections</span>
                      <span className={`px-3 py-1 rounded-full text-sm font-medium ${
                        ytConnected ? "bg-green-500/20 text-green-400" : "bg-red-500/20 text-red-400"
                      }`}>
                  ...
                  <p className="text-white/60 text-sm mb-6">
                    Make sure you're logged into the account you want to connect before clicking below.
                  </p>
            ...
            {activeTab === "Channel Manager" && (
              <div className="bg-gradient-to-br from-[#1E1E1E] to-[#2A2A2A] border border-[#3A3A3A] rounded-2xl p-8 shadow-2xl flex flex-col h-full">
                <div className="flex-1 flex flex-col">
                  ...
                  <p className="text-white/60 text-sm mb-6">
                    Organize your social media accounts into channels for better content management
                  </p>
                  ...
                  <div className="space-y-4 w-full">
                    ...
                    <Button className="bg-gradient-to-r from-[#6E42E1] to-[#8B5CF6] hover:from-[#7d55e6] hover:to-[#9c76ff] text-white px-8 py-6 text-lg font-semibold hover:scale-105 transition-transform">
                      Create Channel
                    </Button>
                  </div>
                </div>
              ...
              <div className="bg-gradient-to-br from-[#1E1E1E] to-[#2A2A2A] border border-[#3A3A3A] rounded-2xl p-8 shadow-2xl flex flex-col h-full">
                <div className="space-y-6 flex-1 flex flex-col">
                  ...
                  >
                    <div className="space-y-4">
                      <div>
                        <label className="block text-white/80 mb-2 text-sm font-medium" htmlFor="current-password">
                          Current Password
                        </label>
                      ...
                      <div>
                        <label className="block text-white/80 mb-2 text-sm font-medium" htmlFor="new-password">
                          New Password
                        </label>
                        <div className="relative">
                          <Input
                      ...
                      <div>
                        <label className="block text-white/80 mb-2 text-sm font-medium" htmlFor="confirm-password">
                    ...
                    {newPassword && (
                      <div className="space-y-2">
                        <div className="flex justify-between text-xs text-white/60">
                          ...
                          <span className={newPassword.length >= 8 ? "text-green-400" : "text-yellow-400"}>
                    ...
                    <Button
                      type="submit"
                      className="w-full bg-gradient-to-r from-[#6E42E1] to-[#8B5CF6] hover:from-[#7d55e6] hover:to-[#9c76ff] text-white py-6 text-lg font-semibold hover:scale-105 transition-transform"
              ...
              <div className="bg-gradient-to-br from-[#1E1E1E] to-[#2A2A2A] border border-[#3A3A3A] rounded-2xl p-8 shadow-2xl flex flex-col h-full">
                <div className="space-y-6 flex-1 flex flex-col">
                  ...
                  <div className="space-y-4">
                    ...
                    <Button
                      className="w-full bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white py-6 text-lg font-semibold hover:scale-105 transition-transform flex items-center justify-center gap-2"
